...
* **Video Player Page:** HTML5 player, dynamic view counter, real-time Like and Dislike toggle buttons, and complete Comment CRUD (Add, Read, Inline Edit, and Delete).
...
* **Data Seeding:** Includes an automated seed script (`seed.js`) to populate mock users, channels, and videos across 6+ categories[cite: 1].

---

## Tech Stack

* **Frontend:** React 18, Vite, React Router DOM, Axios, Lucide React[cite: 1]
* **Backend:** Node.js, Express.js, JSON Web Tokens (JWT), Bcrypt.js, CORS, Dotenv[cite: 1]
* **Database:** MongoDB (Atlas / Mongoose ODM)[cite: 1]
* **Architecture:** ES Modules (`type: module`)[cite: 1]
